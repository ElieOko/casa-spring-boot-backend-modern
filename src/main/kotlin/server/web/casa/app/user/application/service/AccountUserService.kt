...
@Service
@Profile(Mode.DEV)
class TypeAccountUserService(
    private val repository: TypeAccountUserRepository,
) {
    suspend fun save(data: TypeAccountUser): TypeAccountUser {
    ...
    suspend fun findByIdAccount(id : Long): TypeAccountUser {
