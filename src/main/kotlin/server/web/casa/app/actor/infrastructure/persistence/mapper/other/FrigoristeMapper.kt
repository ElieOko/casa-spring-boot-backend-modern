...
@Component
class FrigoristeMapper(
    private val userMapper: UserMapper,
    private val typeCardMapper: TypeCardMapper
) {
    fun toDomain(e: FrigoristeEntity) : Frigoriste {
            return Frigoriste(
                frigoristeId = e.frigoristeId,
    ...
    fun toEntity(m: Frigoriste): FrigoristeEntity {
            return FrigoristeEntity(
                frigoristeId = m.frigoristeId,
