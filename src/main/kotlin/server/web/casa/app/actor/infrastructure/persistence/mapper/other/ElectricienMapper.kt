...
@Component
class ElectricienMapper(
    private val userMapper: UserMapper,
    private val typeCardMapper: TypeCardMapper
) {
    fun toDomain(e: ElectricienEntity) : Electricien {
            return Electricien(
                electricienId = e.electricienId,
    ...
    fun toEntity(m: Electricien): ElectricienEntity {
            return ElectricienEntity(
                electricienId = m.electricienId,
