...
fun City.toEntity() = CityEntity(id = this.cityId, countryId = this.country, name = this.name)

fun CityEntity.toDomain() = City(cityId = this.id, country = this.countryId, name = this.name)
