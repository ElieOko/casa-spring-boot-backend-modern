...
import server.web.casa.app.property.domain.model.favorite.FavoriteVacanceRequest
...
const val ROUTE_FAVORITE_VACANCE = FavoriteFestiveRoute.FAVORITE_VACANCE_PATH

@Tag(name = "Favorite Terrain", description = "Gestion des favorites")
@RestController
@Profile(Mode.DEV)
@RequestMapping(ROUTE_FAVORITE_VACANCE)
class FavoriteVacanceController(
    ...
    @GetMapping("/salle/{vacanceId}", produces = [MediaType.APPLICATION_JSON_VALUE])
