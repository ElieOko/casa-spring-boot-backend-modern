...
fun PropertyFavoriteEntity.toDomain() = PropertyFavorite( propertyFavoriteId = this.propertyFavoriteId)

fun PropertyFavorite.toEntity() = PropertyFavoriteEntity( propertyFavoriteId = this.propertyFavoriteId)