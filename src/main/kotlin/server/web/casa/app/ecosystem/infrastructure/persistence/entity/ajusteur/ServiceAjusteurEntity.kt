...
@Entity
@Table(name = "service_ajusteurs")
class ServiceAjusteurEntity(
    @Id
    @Column("id")
    ...
    val realisation : MutableSet<ServiceAjusteurRealisationEntity> = mutableSetOf(),
...
fun ServiceAjusteurEntity.toDomain(): AjusteurTask = AjusteurTask(
    id = this.id,
