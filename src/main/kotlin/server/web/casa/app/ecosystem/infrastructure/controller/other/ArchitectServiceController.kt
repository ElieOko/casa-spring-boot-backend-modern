...
import server.web.casa.app.ecosystem.application.service.task.ArchitectServiceAction
...
import server.web.casa.app.ecosystem.domain.request.ArchitectServiceRequest
...
@Tag(name = "Architect Service", description = "Gestion des services Architect")
@RestController
@RequestMapping(Service.ARCHITECT)
class ArchitectServiceController(
    private val serviceAction : ArchitectServiceAction,
    private val userService: UserService,
    private val deviseService: DeviseService,
    private val realisationImage : RealisationArchitectServiceAction,
    private val cityService: CityService,
    private val communeService: CommuneService,
    private val quartierService: QuartierService
) {
    @PostMapping(consumes = [MediaType.APPLICATION_JSON_VALUE])
    suspend fun createArchitectService(
        @Valid @RequestBody request: ArchitectServiceRequest,
        ...
        if (realisation.isNotEmpty()){
            val entity = ServiceArchitectEntity(
    ...
    @Operation(summary = "Voir les Architect service")
    @GetMapping(produces = [MediaType.APPLICATION_JSON_VALUE])
    suspend fun getAllArchitect(): ResponseEntity<Map<String, List<ArchitectTask>>> {
        val response = mapOf("architects" to serviceAction.getAllData())
