...
@Entity
@Table(name = "service_salubrites")
class ServiceSalubriteEntity(
    @Id
    @Column("id")
    ...
    val realisation : MutableSet<ServiceSalubriteRealisationEntity> = mutableSetOf(),
...
fun ServiceSalubriteEntity.toDomain() = SalubriteTask(
    id = this.id,
