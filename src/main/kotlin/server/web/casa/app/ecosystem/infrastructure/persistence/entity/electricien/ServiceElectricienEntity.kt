...
@Entity
@Table(name = "service_electriciens")
class ServiceElectricienEntity(
    @Id
    @Column("id")
    ...
    val electricienRealisation : MutableSet<ServiceElectricienRealisationEntity> = mutableSetOf(),
...
fun ServiceElectricienEntity.toDomain() = ElectricienTask(
    id = this.id,
