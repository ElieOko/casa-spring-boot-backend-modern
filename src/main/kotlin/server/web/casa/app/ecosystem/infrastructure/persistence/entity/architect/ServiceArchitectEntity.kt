...
@Entity
@Table(name = "service_architects")
class ServiceArchitectEntity(
    @Id
    @Column("id")
    ...
    val realisation : MutableSet<ServiceArchitectRealisationEntity> = mutableSetOf(),
...
fun ServiceArchitectEntity.toDomain() = ArchitectTask(
    id = this.id,
