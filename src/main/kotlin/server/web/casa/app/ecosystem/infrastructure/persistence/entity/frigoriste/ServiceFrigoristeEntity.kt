...
@Entity
@Table(name = "service_frigoristes")
class ServiceFrigoristeEntity(
    @Id
    @Column("id")
    ...
    val realisation : MutableSet<ServiceFrigoristeRealisationEntity> = mutableSetOf(),
...
fun ServiceFrigoristeEntity.toDomain() = FrigoristeTask(
    id = this.id,
