package server.web.casa.app.ecosystem.infrastructure.persistence.entity.peintre
...
@Entity
@Table(name = "service_peintres")
class ServicePeintreEntity(
    @Id
    @Column("id")
    ...
    val peintreRealisation : MutableSet<ServicePeintreRealisationEntity> = mutableSetOf(),
...
fun ServicePeintreEntity.toDomain() = PeintreTask(
    id = this.id,
