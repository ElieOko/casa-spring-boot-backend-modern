...
@Service
class RealisationFrigoristeServiceAction(
    private val repository: FrigoristeRealisationRepository,
    private val gcsService: GcsService,
    private val storageService: FileSystemStorageService
) {
    private val log = LoggerFactory.getLogger(this::class.java)
    private val model = "frigoriste"
    suspend fun create(p : FrigoristeRealisation,server : String): FrigoristeRealisation {
...
//        log.info("public url local $fileUrl")
        p.path = imageUri!!
        val data = ServiceFrigoristeRealisationEntity(
