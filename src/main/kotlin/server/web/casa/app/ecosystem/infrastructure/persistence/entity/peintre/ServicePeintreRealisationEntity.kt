...
class ServicePeintreRealisationEntity (
    @Id
    @Column("id")
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    val id : Long = 0,
    @ManyToOne
    @JoinColumn("service_peintre_id")
    @JsonBackReference
    var service : ServicePeintreEntity,
    @Column(name = "name")
    val name : String,
...
fun ServicePeintreRealisationEntity.toDomain() = PeintreRealisation(
    id = this.id,
