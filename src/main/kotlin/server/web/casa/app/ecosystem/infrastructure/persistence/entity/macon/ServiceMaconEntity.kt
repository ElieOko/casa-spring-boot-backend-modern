...
@Entity
@Table(name = "service_macons")
class ServiceMaconEntity(
    @Id
    @Column("id")
    ...
    val realisation : MutableSet<ServiceMaconRealisationEntity> = mutableSetOf(),
...
fun ServiceMaconEntity.toDomain() = MaconTask(
    id = this.id,
